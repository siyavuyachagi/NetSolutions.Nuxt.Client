    ...
    <div class="min-h-screen bg-gray-50 p-6">
        ...
        <header class="flex justify-between items-center mb-8">
            ...
            <div class="flex items-center space-x-4">
                ...
                <div class="relative">
                    <img :src="client?.profileImage?.viewLink" alt="Profile"
                ...
                <div class="md:col-span-1 bg-white shadow rounded-lg p-6">
                    <div class="text-center">
                        <div class="relative inline-block mb-4">
                            <img :src="client?.profileImage?.viewLink || '/api/placeholder/150/150'"
                                alt="Profile Picture" class="w-32 h-32 rounded-full object-cover mx-auto mb-4" />
                            <label
                        ...
                        <h2 class="text-2xl font-bold text-gray-800">{{ client?.lastName }} {{ client?.firstName }}</h2>
