<template>
    ...
    <footer class="bg-white mt-6 shadow">
        <div class="container mx-auto px-4 py-12 grid md:grid-cols-4 gap-8">
            ...
            <div>
                ...
                <p class="text-gray-500 mb-2">
                    Email: <a class="hover:text-primary-300" href="mailto:netsolution2025@outlook.com">netsolution2025@outlook.com</a>
                </p>
                <p class="text-gray-500 mb-2">
        ...
        <div class="bg-neutral-800 text-center text-white/60 py-1">
            <p>&copy; {{ new Date().getFullYear() }} NetSolutions. All Rights Reserved.</p>
        </div>
    </footer>
</template>