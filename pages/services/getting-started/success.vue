    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="mb-6">
            <div class="flex items-center text-sm text-neutral-500">
                ...
                <NuxtLink :to="`/services/${subscription?.businessServicePackage.businessServiceId}`"
                    class="hover:text-primary-500 transition">
                    {{ subscription?.businessServicePackage.businessService.name }}
                </NuxtLink>
                <span class="mx-2">/</span>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="bg-white rounded-lg shadow-md p-6">
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="text-center py-6">
                            ...
                            <p class="text-sm text-neutral-500 mb-4">Reference ID: {{ subscription?.id }}</p>
            ...
            <div class="space-y-6">
                ...
                <div class="bg-white rounded-lg shadow-md p-6">
                    <h3 class="text-lg font-semibold text-neutral-800 mb-4">Subscription
                    </h3>

                    <div class="bg-neutral-50 rounded-lg p-4 mb-4">
                        <div class="flex justify-between items-center mb-2">
                            <h4 class="font-bold text-neutral-800">Total Price</h4>
                            <span :class="pkgColor(subscription?.businessServicePackage.name || '')">
                                {{ subscription?.businessServicePackage.name }}
                            </span>
                        </div>

                        <div class="mb-2">
                            <span class="text-xl font-bold text-neutral-800 mr-2">R{{
                                subscription?.businessServicePackage.price
                                }}</span>
                            <span class="text-neutral-500 text-sm">/{{
                                subscription?.businessServicePackage.billingCycle }}</span>
                        </div>

                        <p class="text-neutral-600 text-sm mt-2">{{ subscription?.businessServicePackage.description }}
                        </p>
                    </div>
                    ...
                    <div class="border-t py-4">
                        ...
                        <ul class="space-y-2">
                            <li v-for="feature in subscription?.businessServicePackage.packageFeatures"
...
//     = useAsyncData(`services-gettingstarted-success-${route.params.id}`, () => businessServicePackageService.getBusinessServicePackage(route.params.id as string));
const { data: subscription, status: subscriptionStatus, refresh: subscriptionRefresh }
    = useAsyncData(`services-gettingstarted-success-subscription-${route.params.id}`, () => subscriptionService.getSubscription(route.query.subscriptionId as string));
...
console.log(await subscription.value);
onMounted(() => {
